...
public class LoginTest extends TestRunner {
    ...
    public void checkUnsuccessful(String email, String password, String firstName) {
        UnsuccessfulLoginPage editAccountPage =
                loadApplication().gotoLoginPage()
                        .unsuccessfulLoginPage(password,firstName)
                        .pressTheLoginButtonSeveralTimes();
        //
        // Check
        Assert.assertEquals(editAccountPage.getAlertWarningText(),UnsuccessfulLoginPage.EXPECTED_LOCK_MESSAGE);
    }
